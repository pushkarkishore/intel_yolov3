# -*- coding: utf-8 -*-
"""
Created on Wed May 20 09:21:55 2020
...
# -*- coding: utf-8 -*-
"""
Created on Wed May 20 09:01:24 2020
    ...
    for i, image_pred in enumerate(predictions):
        ...
        for cls in unique_classes:
            ...
            while len(cls_boxes) > 0:
                ...
                print("classboxes",cls_boxes)
                print("classscores",cls_scores)
...
def main(argv=None):
    ...
    while True:
        ...
        pantry.append(time.time() - t0)
        print("score",filtered_boxes)
